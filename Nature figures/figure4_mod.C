...
double tvals[8] = {0.02, 0.055, 0.095, 0.11,0.15,0.2,0.26,0.34};
double dvals[8] = {-2.372, -2.153, -1.599, -1.57,-1.36,-1.28,-1.10,-0.92};
double errors[8] = {0.1,0.1,0.1, 0.1,0.08,0.08,0.07,0.07};

void figure4_mod(void){
 ...
 CAN->SetGrid();
 TGraphErrors *myG = new TGraphErrors(8,tvals,dvals,0,errors);
 ...
 TF1 *powerlawfit = new TF1("powerlawfit","[0]*TMath::Power(1+x/([1]*[1]),-3)",0.0,0.4);
